...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <br />
    <div id="tablaFactura">
        <asp:GridView ID="gvFactura" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AllowPaging="True" PageIndex="10" CssClass="table-condensed">
            <Columns>
